...
Install server-side alongside its declared dependencies (see `fabric.mod.json`). No client installation is needed; clients with Pandorical additionally get the compact count labels.
